        ...
        <flux:sidebar sticky stashable class="border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.group heading="Central" class="grid">
                    ...
                    <flux:navlist.item icon="computer-desktop" :href="route('scendpoints.index')" :current="request()->routeIs('scendpoints.index')" wire:navigate>SC Endpoints (soon)</flux:navlist.item>
